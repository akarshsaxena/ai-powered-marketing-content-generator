...
import { ArrowLeft, XCircle, RefreshCw, Send, Pencil } from "lucide-react";
...
const SuggestedContent = () => {
  ...
  const [sendEnabled, setSendEnabled] = useState(false); // 👈 new state for send button enable/disable

  const qualityScore = 92;

  // when coming back from approval page, enable Send if approved
  useEffect(() => {
        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3 justify-center sm:justify-start">
              ...
              <Button
                onClick={handleSend}
                disabled={!sendEnabled} // disabled initially
